...
const findbmi=()=>{
    ...
    return (
        <div className=' flex justify-center align-items-center  min-h-screen bg-sky-800 '>
            <div className=' p-12 shadow-md shadow-white border-black bg-blue-400 flex items-center justify-center flex-col rounded-xl'>
